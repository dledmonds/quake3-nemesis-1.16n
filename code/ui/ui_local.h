...
// Nemesis - makes qvm compiler sane
typedef void (*voidfunc_f)(void);
typedef void (*intfunc_f)(int);
...
// ui_mods.c
//
//extern void UI_Mods_MenuEvent( void *ptr, int event );
extern void UI_ModsMenu( void );
extern void UI_NemesisMenu( void );
extern void UI_SuperHudMenu( void );
