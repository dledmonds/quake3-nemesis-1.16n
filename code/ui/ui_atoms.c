...
void UI_SetActiveMenu( uiMenuCommand_t menu ) {
	...
	case UIMENU_MAIN:
		...
		return;
	case UIMENU_NEED_CD:
		UI_ConfirmMenu( "Insert the CD", (voidfunc_f)0, NeedCDAction );	// Nemesis - compiler warning fix
		return;
	case UIMENU_BAD_CD_KEY:
		UI_ConfirmMenu( "Bad CD Key", (voidfunc_f)0, NeedCDKeyAction );	// Nemesis - compiler warning fix
		return;
	case UIMENU_INGAME:
