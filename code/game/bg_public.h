...
#define MOD_NAME			"Nemesis"

#define MOD_NUMBER			"2.0.14"

#ifdef Q3_VM
#define MOD_VERSION			MOD_NUMBER
#else
#define MOD_VERSION			MOD_NUMBER " DLL"
#endif

#define MOD_WEBSITE			"http://www.q3nemesis.com"
#define MOD_AUTHORS			"Cyrus & Wonkey"
#define MOD_FULLNAME		MOD_NAME " " MOD_VERSION  // full details for cgame CVAR
#define MOD_DELIMITER		'-'  // delimits multi data in one cvar such as cg_enemyColor
...
#ifdef NMS_MULTIVIEW
// Multiview settings
#define MAX_MVCLIENTS		32		// DOCUMENT ME!
#endif
...
#define CS_DA_STRING		16		// cgame
#define CS_PRO_MODE			17
...
typedef enum {
	...
	GT_FREEZE,			// Nemesis - freeze detection
...
#ifdef NMS_MULTIVIEW
	/* OSP - Multiview client info.. need a full 32 bits
	 * used to transmit the current multiview client list to the client */
	PW_MVCLIENTLIST = 15,
#endif
